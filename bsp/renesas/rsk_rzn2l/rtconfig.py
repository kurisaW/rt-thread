...
if PLATFORM == 'gcc':
    ...
    DEVICE = ' -mcpu=cortex-r52 -mthumb -mfloat-abi=hard -mfpu=neon-fp-armv8 -fdiagnostics-parseable-fixits -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -funwind-tables'
    CFLAGS = DEVICE + ' -Dgcc'
